...
static void cb_pos_menu_select( GtkWidget       *item,
                                GtkPositionType  pos)
{
	/* Set up the value position on both scale widgets */
...
{
	/* Set the update policy for scale widgets */
                          ...
                          GtkAdjustment *set)
{
	...
	gtk_signal_emit_by_name(G_OBJECT(set), "changed");
}
...
static void create_range_controls ( void )
{
	...
	/* Notice ho this causes the scales to always be updated 
